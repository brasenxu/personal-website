...
// Inline SVG icons for social media to replace the heavy 935 KiB SimpleIcons font
// This dramatically improves FCP and LCP by eliminating the font download
...
export const DevpostIcon = ({ className }: IconProps) => (
  <svg
    role="img"
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
